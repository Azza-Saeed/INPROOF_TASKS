...
void dio_vidFlipChannel(dio_portId_t port, dio_channelId_t channel)
{
	...
	{
	case DIO_PORTB:
		TGL_BIT(DIO_PORTB_REG,channel);
		break;

	case DIO_PORTC:
		TGL_BIT(DIO_PORTC_REG,channel);
		break;

	case DIO_PORTD:
		TGL_BIT(DIO_PORTD_REG,channel);
		break;
	}
}
...
void dio_vidEnablePullUp(dio_portId_t port, dio_channelId_t channel)
{
	...
	{
		case DIO_PORTB:
			if(GET_BIT(DIO_DDRB_REG,channel) == INPUT)
			{
				SET_BIT(DIO_PORTB_REG,channel);
			}
		break;
		...
		case DIO_PORTC:
			if(GET_BIT(DIO_DDRC_REG,channel) == INPUT)
			{
				SET_BIT(DIO_PORTC_REG,channel);
			}
		break;
		...
		case DIO_PORTD:
			if(GET_BIT(DIO_DDRD_REG,channel) == INPUT)
			{
				SET_BIT(DIO_PORTD_REG,channel);
			}
		break;
